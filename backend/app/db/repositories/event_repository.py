...
class EventRepository:
    ...
    async def add_participant(self, event_id: str, user_id: str) -> Event:
        ...
        if not ObjectId.is_valid(event_id) or not ObjectId.is_valid(user_id):
            raise NotFoundException(detail=f"Invalid ID provided")
    ...
    async def increment_checkin_count(self, event_id: str) -> Event:
        """Increment an event's total check-in count.
