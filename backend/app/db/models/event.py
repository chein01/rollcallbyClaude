...
class Event(BaseDBModel):
    ...
    participants: List[PyObjectId] = Field(default_factory=list)  # Users who joined this event
    total_checkins: int = Field(default=0)  # Total number of check-ins across all participants
    ...
    class Config:
        ...
        schema_extra = {
            "example": {
                ...
                "icon": "code",
                "is_public": True,
                "participants": ["60d5e1c7a0f5a5a5a5a5a5a5", "60d5e1c7a0f5a5a5a5a5a5a6"],
                "total_checkins": 156
            }
        }
