...
class StreakFreeze(BaseDBModel):
    ...
    is_used = Column(Boolean, default=False, nullable=False)  # Whether the freeze has been used
    expiry_date = Column(DateTime, nullable=True)  # Optional expiration date for the freeze
